...
export default function Summary() {
  ...
  const cardData = [
    { 
      ...
      images: [{ src: `${assetPath}first.png`, style: "bottom-0 left-1/2 -translate-x-1/2 w-[80%] md:w-[60%] md:right-1/3 md:translate-x-1/2 xl:w-[500px] xl:right-1/3 xl:translate-x-1 object-contain object-bottom scale-[1.02]" }]
    },
    { 
      title: "기획부터 디자인. 개발까지.\n폭넓은 경험은 더욱 환상적.",
