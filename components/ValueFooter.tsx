        ...
        <div className="flex flex-col xl:grid xl:grid-cols-3 gap-[20px] w-full items-stretch">
          {VALUE_CARDS.map((card) => (
            <div 
              ...
              className="flex flex-col items-start p-[32px] md:p-[40px] xl:p-[40px] gap-[24px] w-full h-auto bg-white rounded-[24px] hover:scale-103 transition-all duration-300"
            >
              {/* 아이콘 이미지 */}
