  ...
  return (
    <section className="relative w-full bg-white flex flex-col items-center xl:py-[140px] md:py-[100px] py-[80px] overflow-hidden">
      <div className="w-full max-w-[1600px] mx-auto px-[20px] md:px-[40px] xl:px-[80px] flex flex-col items-center xl:gap-[100px] md:gap-[80px] gap-[60px]">
        ...
        {/* 하단 텍스트 및 버튼 영역 */}
        <div className="w-full flex flex-col items-center xl:gap-[40px] md:gap-[80px] gap-[40px]">
          <div className="md:w-[80%] w-full flex flex-col md:flex-row justify-between items-start gap-[24px] md:gap-[40px] xl:gap-[80px]">
            <p className="font-wanted font-semibold text-[#737373] xl:text-[20px] xl:leading-[28px] md:text-[18px] md:leading-[26px] text-[16px] leading-[1.6] md:flex-1 break-keep">
            ...
            <div className="flex flex-col gap-[4px] md:w-auto xl:w-[343px]">
              ...
              <h3 className="font-wanted font-bold xl:text-[40px] xl:leading-[52px] md:text-[32px] md:leading-[42px] text-[24px] leading-[3px]
                bg-gradient-to-r from-[#449EFF] via-[#A4D0FF] to-[#BDDDFF] bg-clip-text text-transparent">
