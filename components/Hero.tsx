      ...
      <div className="w-full max-w-[1600px] 
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-end gap-10 md:gap-0 mt-[40px] xl:mt-[70px]">
          <div className="flex flex-col items-start gap-[6px]">
            ...
            <h1 className="text-[32px] md:text-[48px] font-bold leading-[1.1] md:leading-[52px] tracking-[0.23px] font-wanted bg-[linear-gradient(94.77deg,#171717_0%,#449EFF_33%,#A4D0FF_66%,#BDDDFF_100%)] bg-clip-text text-transparent bg-[length:300%_auto] animate-rainbow-flow">
              완전함의 재정의.<br />
              기획부터 개발까지.
            </h1>
          </div>
