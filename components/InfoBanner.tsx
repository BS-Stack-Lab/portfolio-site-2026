  ...
  return (
    <section className="relative w-full overflow-hidden transition-all duration-300
      ...
      <div className="relative w-full max-w-[1280px] h-full mx-auto flex flex-col items-center">
        ...
        {/* 1. 소제목: 내 정보. */}
        <span className="absolute top-[140px] font-wanted font-bold xl:text-[24px] xl:leading-[32px] md:text-[24px] md:leading-[32px] text-[16px] leading-[24px] tracking-[-0.23px] text-[#171717] text-center">
          내 정보.
        </span>

        {/* 2. 메인 타이틀: 더욱더 과감하게. 더욱더 세밀하게. */}
        <h2 className="absolute top-[204px] w-full max-w-[700px] font-wanted font-bold 
          xl:text-[80px] xl:leading-[94px] md:text-[68px] md:leading-[80px] text-[48px] leading-[52px]
        ...
        <p className="absolute top-[424px] w-full max-w-[700px] px-[20px] font-wanted font-semibold 
          xl:text-[20px] xl:leading-[28px] mb:text-[20px] mb:leading-[28px] text-[16px] leading-[24px]
